...
{
    public function testValiderFraisAsComptable()
    {
        ...
        $client->loginUser($comptable);
        $client->request('GET', '/comptable/manegeFF');

        $this->assertResponseIsSuccessful();
    }

    public function testValiderFraisForbiddenForUser()
    {
        $client = static::createClient();
        $entityManager = static::getContainer()->get(EntityManagerInterface::class);
        DatabaseTestCase::createDatabaseSchema($entityManager);
